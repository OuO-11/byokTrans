...
export function openDB() {
  return new Promise((resolve, reject) => {
    ...
    request.onerror = (e) =>
      reject("Failed to open database: " + e.target.error);
...
export async function deleteNovel(novelId) {
  ...
  return new Promise((resolve, reject) => {
    ...
    transaction.onerror = (e) =>
      reject("Failed to delete novel data: " + e.target.error);
  });
}
...
export async function saveEpisode(
  ...
  return new Promise((resolve, reject) => {
    ...
    request.onerror = (e) =>
      reject("Failed to save episode cache: " + e.target.error);
  });
}
...
export async function getEpisode(novelId, chapter) {
  ...
  return new Promise((resolve, reject) => {
    ...
    request.onsuccess = () => resolve(request.result);
    request.onerror = (e) =>
      reject("Failed to get episode cache: " + e.target.error);
  });
}
...
export async function deleteEpisodes(novelId, chapters) {
  ...
  return new Promise((resolve, reject) => {
    ...
    transaction.oncomplete = () => resolve(true);
    transaction.onerror = (e) =>
      reject("Failed to delete chapters: " + e.target.error);
  });
}
...
export async function clearOldEpisodes(daysLimit) {
  ...
  return new Promise((resolve, reject) => {
    ...
    transaction.oncomplete = () => resolve(true);
    transaction.onerror = (e) =>
      reject("Failed to clear old episodes: " + e.target.error);
  });
}
...
export async function getCacheStatistics() {
  ...
  return new Promise((resolve, reject) => {
    ...
    transaction.onerror = (e) =>
      reject("Failed to fetch cache stats: " + e.target.error);
  });
}
  ...
  return new Promise((resolve, reject) => {
    ...
    transaction.oncomplete = () => {
      ...
      const localSettings = {
        ...
        reader_settings:
          localStorage.getItem("noveltrans_reader_settings") || "",
    ...
    transaction.onerror = (e) =>
      reject("Failed to export data: " + e.target.error);
  });
}
...
export async function importAllData(base64Str) {
  ...
  return new Promise((resolve, reject) => {
    ...
    transaction.oncomplete = () => resolve(true);
    transaction.onerror = (e) =>
      reject("데이터 복원에 실패했습니다: " + e.target.error);
  });
}
